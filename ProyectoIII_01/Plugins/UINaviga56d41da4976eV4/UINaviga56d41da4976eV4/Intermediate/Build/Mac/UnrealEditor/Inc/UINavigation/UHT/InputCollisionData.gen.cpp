...
struct Z_Construct_UScriptStruct_FInputCollisionData_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CurrentKeyIndex_MetaData[] = {
		{ "Category", "InputCollisionData" },
		{ "ModuleRelativePath", "Public/Data/InputCollisionData.h" },
	};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FInputCollisionData_Statics::NewProp_CurrentKeyIndex = { "CurrentKeyIndex", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInputCollisionData, CurrentKeyIndex), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurrentKeyIndex_MetaData), NewProp_CurrentKeyIndex_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FInputCollisionData_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FInputCollisionData_Statics::NewProp_CurrentKeyIndex,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_Data_InputCollisionData_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FInputCollisionData::StaticStruct, Z_Construct_UScriptStruct_FInputCollisionData_Statics::NewStructOps, TEXT("InputCollisionData"), &Z_Registration_Info_UScriptStruct_InputCollisionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputCollisionData), 2666857586U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_Data_InputCollisionData_h_2962498461(TEXT("/Script/UINavigation"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_Data_InputCollisionData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_Data_InputCollisionData_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
