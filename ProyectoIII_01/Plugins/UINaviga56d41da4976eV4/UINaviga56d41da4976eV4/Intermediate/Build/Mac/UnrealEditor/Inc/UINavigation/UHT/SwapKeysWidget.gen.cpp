...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USwapKeysWidget_Statics::NewProp_InputCollisionData = { "InputCollisionData", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USwapKeysWidget, InputCollisionData), Z_Construct_UScriptStruct_FInputCollisionData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InputCollisionData_MetaData), NewProp_InputCollisionData_MetaData) }; // 2666857586
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_SwapKeysWidget_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USwapKeysWidget, USwapKeysWidget::StaticClass, TEXT("USwapKeysWidget"), &Z_Registration_Info_UClass_USwapKeysWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USwapKeysWidget), 4130730450U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_SwapKeysWidget_h_2219661316(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_SwapKeysWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_SwapKeysWidget_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
