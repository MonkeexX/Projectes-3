...
struct Z_Construct_UFunction_UUINavInputContainer_CanUseKey_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bIsHold_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif // WITH_METADATA
	...
	static void NewProp_bIsHold_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bIsHold;
...
void Z_Construct_UFunction_UUINavInputContainer_CanUseKey_Statics::NewProp_bIsHold_SetBit(void* Obj)
{
	((UINavInputContainer_eventCanUseKey_Parms*)Obj)->bIsHold = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUINavInputContainer_CanUseKey_Statics::NewProp_bIsHold = { "bIsHold", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UINavInputContainer_eventCanUseKey_Parms), &Z_Construct_UFunction_UUINavInputContainer_CanUseKey_Statics::NewProp_bIsHold_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsHold_MetaData), NewProp_bIsHold_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavInputContainer_CanUseKey_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavInputContainer_CanUseKey_Statics::NewProp_bIsHold,
...
DEFINE_FUNCTION(UUINavInputContainer::execCanUseKey)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->CanUseKey(Z_Param_InputBox,Z_Param_CompareKey,Z_Param_bIsHold,Z_Param_Out_OutCollidingActionIndex,Z_Param_Out_OutCollidingKeyIndex);
	P_NATIVE_END;
}
// End Class UUINavInputContainer Function CanUseKey

// Begin Class UUINavInputContainer Function ForceUpdateInputBoxes
struct Z_Construct_UFunction_UUINavInputContainer_ForceUpdateInputBoxes_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UINav Input" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavInputContainer_ForceUpdateInputBoxes_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavInputContainer, nullptr, "ForceUpdateInputBoxes", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavInputContainer_ForceUpdateInputBoxes_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavInputContainer_ForceUpdateInputBoxes_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UUINavInputContainer_ForceUpdateInputBoxes()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavInputContainer_ForceUpdateInputBoxes_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavInputContainer::execForceUpdateInputBoxes)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ForceUpdateInputBoxes();
	P_NATIVE_END;
}
// End Class UUINavInputContainer Function ForceUpdateInputBoxes
...
static const FName NAME_UUINavInputContainer_OnAddInputBox = FName(TEXT("OnAddInputBox"));
void UUINavInputContainer::OnAddInputBox(UUINavInputBox* NewInputBox)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavInputContainer_OnAddInputBox);
	...
	{
		OnAddInputBox_Implementation(NewInputBox);
	}
}
...
// Begin Class UUINavInputContainer Function OnInputTypeChanged
struct Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics
{
	struct UINavInputContainer_eventOnInputTypeChanged_Parms
	{
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::NewProp_InputType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::NewProp_InputType = { "InputType", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavInputContainer_eventOnInputTypeChanged_Parms, InputType), Z_Construct_UEnum_UINavigation_EInputType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InputType_MetaData), NewProp_InputType_MetaData) }; // 346009216
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::NewProp_InputType_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::NewProp_InputType,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavInputContainer, nullptr, "OnInputTypeChanged", nullptr, nullptr, Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::UINavInputContainer_eventOnInputTypeChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::UINavInputContainer_eventOnInputTypeChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavInputContainer::execOnInputTypeChanged)
{
	P_GET_ENUM(EInputType,Z_Param_InputType);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->OnInputTypeChanged(EInputType(Z_Param_InputType));
	P_NATIVE_END;
}
// End Class UUINavInputContainer Function OnInputTypeChanged
...
static const FName NAME_UUINavInputContainer_OnKeyRebinded = FName(TEXT("OnKeyRebinded"));
void UUINavInputContainer::OnKeyRebinded(FName InputName, FKey OldKey, FKey NewKey)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavInputContainer_OnKeyRebinded);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnKeyRebinded_Implementation(InputName, OldKey, NewKey);
	}
}
...
static const FName NAME_UUINavInputContainer_OnRebindCancelled = FName(TEXT("OnRebindCancelled"));
void UUINavInputContainer::OnRebindCancelled(ERevertRebindReason RevertReason, FKey PressedKey)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavInputContainer_OnRebindCancelled);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnRebindCancelled_Implementation(RevertReason, PressedKey);
	}
}
...
void UUINavInputContainer::StaticRegisterNativesUUINavInputContainer()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "ForceUpdateInputBoxes", &UUINavInputContainer::execForceUpdateInputBoxes },
		{ "GetInputBoxAtIndex", &UUINavInputContainer::execGetInputBoxAtIndex },
		{ "OnAddInputBox", &UUINavInputContainer::execOnAddInputBox },
		{ "OnInputTypeChanged", &UUINavInputContainer::execOnInputTypeChanged },
...
struct Z_Construct_UClass_UUINavInputContainer_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HoldText_MetaData[] = {
		{ "Category", "UINav Input" },
		{ "Comment", "//The text used for specifying that an key is used as a Hold\n" },
		{ "ModuleRelativePath", "Public/UINavInputContainer.h" },
		{ "ToolTip", "The text used for specifying that an key is used as a Hold" },
	};
	...
	static const UECodeGen_Private::FTextPropertyParams NewProp_HoldText;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UUINavInputContainer_CanUseKey, "CanUseKey" }, // 1899227647
		{ &Z_Construct_UFunction_UUINavInputContainer_ForceUpdateInputBoxes, "ForceUpdateInputBoxes" }, // 3473830272
		{ &Z_Construct_UFunction_UUINavInputContainer_GetInputBoxAtIndex, "GetInputBoxAtIndex" }, // 2973830402
		{ &Z_Construct_UFunction_UUINavInputContainer_OnAddInputBox, "OnAddInputBox" }, // 370959357
		{ &Z_Construct_UFunction_UUINavInputContainer_OnInputTypeChanged, "OnInputTypeChanged" }, // 286338125
		{ &Z_Construct_UFunction_UUINavInputContainer_OnKeyRebinded, "OnKeyRebinded" }, // 2714836712
		{ &Z_Construct_UFunction_UUINavInputContainer_OnRebindCancelled, "OnRebindCancelled" }, // 3214177298
...
const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UUINavInputContainer_Statics::NewProp_HoldText = { "HoldText", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUINavInputContainer, HoldText), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HoldText_MetaData), NewProp_HoldText_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUINavInputContainer_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUINavInputContainer_Statics::NewProp_HoldText,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavInputContainer_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUINavInputContainer, UUINavInputContainer::StaticClass, TEXT("UUINavInputContainer"), &Z_Registration_Info_UClass_UUINavInputContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUINavInputContainer), 2676244668U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavInputContainer_h_3929051025(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavInputContainer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavInputContainer_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
