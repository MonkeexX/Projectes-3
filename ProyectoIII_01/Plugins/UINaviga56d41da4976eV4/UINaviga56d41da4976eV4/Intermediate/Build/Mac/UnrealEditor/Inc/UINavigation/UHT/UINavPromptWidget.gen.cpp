...
static const FName NAME_UUINavPromptWidget_ProcessPromptWidgetSelected = FName(TEXT("ProcessPromptWidgetSelected"));
void UUINavPromptWidget::ProcessPromptWidgetSelected(UPromptDataBase* InPromptData)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavPromptWidget_ProcessPromptWidgetSelected);
	...
	{
		ProcessPromptWidgetSelected_Implementation(InPromptData);
	}
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPromptWidget_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUINavPromptWidget, UUINavPromptWidget::StaticClass, TEXT("UUINavPromptWidget"), &Z_Registration_Info_UClass_UUINavPromptWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUINavPromptWidget), 2661079995U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPromptWidget_h_307560419(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPromptWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPromptWidget_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
