...
static const FName NAME_UUINavHorizontalComponent_OnNavigateLeft = FName(TEXT("OnNavigateLeft"));
void UUINavHorizontalComponent::OnNavigateLeft()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavHorizontalComponent_OnNavigateLeft);
...
static const FName NAME_UUINavHorizontalComponent_OnNavigateRight = FName(TEXT("OnNavigateRight"));
void UUINavHorizontalComponent::OnNavigateRight()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavHorizontalComponent_OnNavigateRight);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
	...
	{
		OnNavigateRight_Implementation();
	}
}
...
static const FName NAME_UUINavHorizontalComponent_OnUpdated = FName(TEXT("OnUpdated"));
void UUINavHorizontalComponent::OnUpdated()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavHorizontalComponent_OnUpdated);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
...
struct Z_Construct_UClass_UUINavHorizontalComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UUINavHorizontalComponent_SetOptionIndex, "SetOptionIndex" }, // 3517587749
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavHorizontalComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUINavHorizontalComponent, UUINavHorizontalComponent::StaticClass, TEXT("UUINavHorizontalComponent"), &Z_Registration_Info_UClass_UUINavHorizontalComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUINavHorizontalComponent), 3372642848U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavHorizontalComponent_h_1713906565(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavHorizontalComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavHorizontalComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
