...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUINavPCComponent_GetUINavInputContext_Statics::NewProp_UINavWidget = { "UINavWidget", nullptr, (EPropertyFlags)0x0010000000080082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavPCComponent_eventGetUINavInputContext_Parms, UINavWidget), Z_Construct_UClass_UUINavWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_UINavWidget_MetaData), NewProp_UINavWidget_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavPCComponent_GetUINavInputContext_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavPCComponent_GetUINavInputContext_Statics::NewProp_UINavWidget,
...
DEFINE_FUNCTION(UUINavPCComponent::execGetUINavInputContext)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UInputMappingContext**)Z_Param__Result=P_THIS->GetUINavInputContext(Z_Param_UINavWidget);
	P_NATIVE_END;
}
...
// Begin Class UUINavPCComponent Function InputKey
struct Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics
{
	struct UINavPCComponent_eventInputKey_Parms
	{
		FKey Key;
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavPCComponent_eventInputKey_Parms, Key), Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Key_MetaData), NewProp_Key_MetaData) }; // 658672854
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::NewProp_Event = { "Event", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavPCComponent_eventInputKey_Parms, Event), Z_Construct_UEnum_Engine_EInputEvent, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Event_MetaData), NewProp_Event_MetaData) }; // 2776698617
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::NewProp_Delta = { "Delta", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavPCComponent_eventInputKey_Parms, Delta), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Delta_MetaData), NewProp_Delta_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::NewProp_Key,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::NewProp_Event,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::NewProp_Delta,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavPCComponent, nullptr, "InputKey", nullptr, nullptr, Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::UINavPCComponent_eventInputKey_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::UINavPCComponent_eventInputKey_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavPCComponent_InputKey()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavPCComponent_InputKey_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavPCComponent::execInputKey)
{
	P_GET_STRUCT_REF(FKey,Z_Param_Out_Key);
	P_GET_PROPERTY(FByteProperty,Z_Param_Event);
	P_GET_PROPERTY(FFloatProperty,Z_Param_Delta);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->InputKey(Z_Param_Out_Key,EInputEvent(Z_Param_Event),Z_Param_Delta);
	P_NATIVE_END;
}
// End Class UUINavPCComponent Function InputKey
...
// Begin Class UUINavPCComponent Function IsWaitingForInputCooldown
struct Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics
{
	struct UINavPCComponent_eventIsWaitingForInputCooldown_Parms
	{
		bool ReturnValue;
	};
#if WITH_METADATA
...
void Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((UINavPCComponent_eventIsWaitingForInputCooldown_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UINavPCComponent_eventIsWaitingForInputCooldown_Parms), &Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavPCComponent, nullptr, "IsWaitingForInputCooldown", nullptr, nullptr, Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::UINavPCComponent_eventIsWaitingForInputCooldown_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::UINavPCComponent_eventIsWaitingForInputCooldown_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavPCComponent::execIsWaitingForInputCooldown)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->IsWaitingForInputCooldown();
	P_NATIVE_END;
}
// End Class UUINavPCComponent Function IsWaitingForInputCooldown
...
// Begin Class UUINavPCComponent Function SimulateReturn
struct Z_Construct_UFunction_UUINavPCComponent_SimulateReturn_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UINavController" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavPCComponent_SimulateReturn_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavPCComponent, nullptr, "SimulateReturn", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_SimulateReturn_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavPCComponent_SimulateReturn_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UUINavPCComponent_SimulateReturn()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavPCComponent_SimulateReturn_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavPCComponent::execSimulateReturn)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SimulateReturn();
	P_NATIVE_END;
}
// End Class UUINavPCComponent Function SimulateReturn

// Begin Class UUINavPCComponent Function SimulateSelect
struct Z_Construct_UFunction_UUINavPCComponent_SimulateSelect_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UINavController" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavPCComponent_SimulateSelect_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavPCComponent, nullptr, "SimulateSelect", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_SimulateSelect_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavPCComponent_SimulateSelect_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UUINavPCComponent_SimulateSelect()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavPCComponent_SimulateSelect_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavPCComponent::execSimulateSelect)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SimulateSelect();
	P_NATIVE_END;
}
// End Class UUINavPCComponent Function SimulateSelect

// Begin Class UUINavPCComponent Function SimulateStartReturn
struct Z_Construct_UFunction_UUINavPCComponent_SimulateStartReturn_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UINavController" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavPCComponent_SimulateStartReturn_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavPCComponent, nullptr, "SimulateStartReturn", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_SimulateStartReturn_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavPCComponent_SimulateStartReturn_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UUINavPCComponent_SimulateStartReturn()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavPCComponent_SimulateStartReturn_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavPCComponent::execSimulateStartReturn)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SimulateStartReturn();
	P_NATIVE_END;
}
// End Class UUINavPCComponent Function SimulateStartReturn

// Begin Class UUINavPCComponent Function SimulateStartSelect
struct Z_Construct_UFunction_UUINavPCComponent_SimulateStartSelect_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UINavController" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavPCComponent_SimulateStartSelect_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavPCComponent, nullptr, "SimulateStartSelect", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_SimulateStartSelect_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavPCComponent_SimulateStartSelect_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UUINavPCComponent_SimulateStartSelect()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavPCComponent_SimulateStartSelect_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavPCComponent::execSimulateStartSelect)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SimulateStartSelect();
	P_NATIVE_END;
}
// End Class UUINavPCComponent Function SimulateStartSelect

// Begin Class UUINavPCComponent Function SimulateStopReturn
struct Z_Construct_UFunction_UUINavPCComponent_SimulateStopReturn_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UINavController" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavPCComponent_SimulateStopReturn_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavPCComponent, nullptr, "SimulateStopReturn", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_SimulateStopReturn_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavPCComponent_SimulateStopReturn_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UUINavPCComponent_SimulateStopReturn()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavPCComponent_SimulateStopReturn_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavPCComponent::execSimulateStopReturn)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SimulateStopReturn();
	P_NATIVE_END;
}
// End Class UUINavPCComponent Function SimulateStopReturn

// Begin Class UUINavPCComponent Function SimulateStopSelect
struct Z_Construct_UFunction_UUINavPCComponent_SimulateStopSelect_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UINavController" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavPCComponent_SimulateStopSelect_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavPCComponent, nullptr, "SimulateStopSelect", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavPCComponent_SimulateStopSelect_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavPCComponent_SimulateStopSelect_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UUINavPCComponent_SimulateStopSelect()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavPCComponent_SimulateStopSelect_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavPCComponent::execSimulateStopSelect)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SimulateStopSelect();
	P_NATIVE_END;
}
// End Class UUINavPCComponent Function SimulateStopSelect
...
void UUINavPCComponent::StaticRegisterNativesUUINavPCComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "InputKey", &UUINavPCComponent::execInputKey },
		...
		{ "IsWaitingForInputCooldown", &UUINavPCComponent::execIsWaitingForInputCooldown },
		...
		{ "SimulateReturn", &UUINavPCComponent::execSimulateReturn },
		{ "SimulateSelect", &UUINavPCComponent::execSimulateSelect },
		{ "SimulateStartReturn", &UUINavPCComponent::execSimulateStartReturn },
		{ "SimulateStartSelect", &UUINavPCComponent::execSimulateStartSelect },
		{ "SimulateStopReturn", &UUINavPCComponent::execSimulateStopReturn },
		{ "SimulateStopSelect", &UUINavPCComponent::execSimulateStopSelect },
	};
...
struct Z_Construct_UClass_UUINavPCComponent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AddedInputContexts_MetaData[] = {
		{ "ModuleRelativePath", "Public/UINavPCComponent.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CurrentInputContext_MetaData[] = {
		{ "ModuleRelativePath", "Public/UINavPCComponent.h" },
	};
	...
	static const UECodeGen_Private::FBytePropertyParams NewProp_AddedInputContexts_ValueProp;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_AddedInputContexts_Key_KeyProp;
	static const UECodeGen_Private::FMapPropertyParams NewProp_AddedInputContexts;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_CurrentInputContext;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UUINavPCComponent_ForceUpdateAllInputDisplays, "ForceUpdateAllInputDisplays" }, // 1916298497
		...
		{ &Z_Construct_UFunction_UUINavPCComponent_GetEnhancedInputIcon, "GetEnhancedInputIcon" }, // 102677139
		{ &Z_Construct_UFunction_UUINavPCComponent_GetEnhancedInputKey, "GetEnhancedInputKey" }, // 3580071177
		{ &Z_Construct_UFunction_UUINavPCComponent_GetEnhancedInputKeys, "GetEnhancedInputKeys" }, // 659937852
		{ &Z_Construct_UFunction_UUINavPCComponent_GetEnhancedInputText, "GetEnhancedInputText" }, // 29523114
		{ &Z_Construct_UFunction_UUINavPCComponent_GetInputMode, "GetInputMode" }, // 1506568804
		...
		{ &Z_Construct_UFunction_UUINavPCComponent_GetSoftEnhancedInputIcon, "GetSoftEnhancedInputIcon" }, // 4257294945
		...
		{ &Z_Construct_UFunction_UUINavPCComponent_GetUINavInputContext, "GetUINavInputContext" }, // 3181914542
		{ &Z_Construct_UFunction_UUINavPCComponent_GoToBuiltWidget, "GoToBuiltWidget" }, // 322446736
		{ &Z_Construct_UFunction_UUINavPCComponent_GoToPromptWidget, "GoToPromptWidget" }, // 1270289448
		{ &Z_Construct_UFunction_UUINavPCComponent_GoToWidget, "GoToWidget" }, // 3089305037
		{ &Z_Construct_UFunction_UUINavPCComponent_HidingMouseCursor, "HidingMouseCursor" }, // 45003424
		{ &Z_Construct_UFunction_UUINavPCComponent_InputKey, "InputKey" }, // 3821563583
		...
		{ &Z_Construct_UFunction_UUINavPCComponent_IsWaitingForInputCooldown, "IsWaitingForInputCooldown" }, // 4007742552
		...
		{ &Z_Construct_UFunction_UUINavPCComponent_SimulateReturn, "SimulateReturn" }, // 2399380412
		{ &Z_Construct_UFunction_UUINavPCComponent_SimulateSelect, "SimulateSelect" }, // 3695386840
		{ &Z_Construct_UFunction_UUINavPCComponent_SimulateStartReturn, "SimulateStartReturn" }, // 2616663413
		{ &Z_Construct_UFunction_UUINavPCComponent_SimulateStartSelect, "SimulateStartSelect" }, // 1420656264
		{ &Z_Construct_UFunction_UUINavPCComponent_SimulateStopReturn, "SimulateStopReturn" }, // 3668117565
		{ &Z_Construct_UFunction_UUINavPCComponent_SimulateStopSelect, "SimulateStopSelect" }, // 2661868392
	};
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UUINavPCComponent_Statics::NewProp_AddedInputContexts_ValueProp = { "AddedInputContexts", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUINavPCComponent_Statics::NewProp_AddedInputContexts_Key_KeyProp = { "AddedInputContexts_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UUINavPCComponent_Statics::NewProp_AddedInputContexts = { "AddedInputContexts", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUINavPCComponent, AddedInputContexts), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AddedInputContexts_MetaData), NewProp_AddedInputContexts_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUINavPCComponent_Statics::NewProp_CurrentInputContext = { "CurrentInputContext", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUINavPCComponent, CurrentInputContext), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurrentInputContext_MetaData), NewProp_CurrentInputContext_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUINavPCComponent_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUINavPCComponent_Statics::NewProp_AddedInputContexts_ValueProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUINavPCComponent_Statics::NewProp_AddedInputContexts_Key_KeyProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUINavPCComponent_Statics::NewProp_AddedInputContexts,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUINavPCComponent_Statics::NewProp_CurrentInputContext,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPCComponent_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUINavPCComponent, UUINavPCComponent::StaticClass, TEXT("UUINavPCComponent"), &Z_Registration_Info_UClass_UUINavPCComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUINavPCComponent), 1177709245U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPCComponent_h_1773360637(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPCComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPCComponent_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPCComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavPCComponent_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
