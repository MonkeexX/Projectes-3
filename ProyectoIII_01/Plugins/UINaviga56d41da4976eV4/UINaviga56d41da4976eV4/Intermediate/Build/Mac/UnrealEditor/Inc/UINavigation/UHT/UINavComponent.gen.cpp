...
static const FName NAME_UUINavComponent_OnNavigatedFrom = FName(TEXT("OnNavigatedFrom"));
void UUINavComponent::OnNavigatedFrom()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavComponent_OnNavigatedFrom);
	...
	{
		OnNavigatedFrom_Implementation();
	}
}
...
static const FName NAME_UUINavComponent_OnNavigatedTo = FName(TEXT("OnNavigatedTo"));
void UUINavComponent::OnNavigatedTo()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavComponent_OnNavigatedTo);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
...
struct Z_Construct_UClass_UUINavComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UUINavComponent_SwitchTextColorTo, "SwitchTextColorTo" }, // 4170064095
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUINavComponent_Statics::NewProp_StyleOverride = { "StyleOverride", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUINavComponent, StyleOverride), Z_Construct_UScriptStruct_FButtonStyle, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StyleOverride_MetaData), NewProp_StyleOverride_MetaData) }; // 1848157003
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavComponent_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUINavComponent, UUINavComponent::StaticClass, TEXT("UUINavComponent"), &Z_Registration_Info_UClass_UUINavComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUINavComponent), 2630496394U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavComponent_h_1028582725(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavComponent_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavComponent_h_Statics::EnumInfo));
// End Registration
