...
// Begin Class UUINavSlider Function SetInterval
struct Z_Construct_UFunction_UUINavSlider_SetInterval_Statics
{
	struct UINavSlider_eventSetInterval_Parms
	{
		float NewInterval;
		bool bNotifyUpdate;
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "UINavSlider" },
		{ "CPP_Default_bNotifyUpdate", "true" },
		{ "ModuleRelativePath", "Public/UINavSlider.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_NewInterval_MetaData[] = {
		{ "NativeConst", "" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bNotifyUpdate_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFloatPropertyParams NewProp_NewInterval;
	static void NewProp_bNotifyUpdate_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bNotifyUpdate;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::NewProp_NewInterval = { "NewInterval", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavSlider_eventSetInterval_Parms, NewInterval), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NewInterval_MetaData), NewProp_NewInterval_MetaData) };
void Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::NewProp_bNotifyUpdate_SetBit(void* Obj)
{
	((UINavSlider_eventSetInterval_Parms*)Obj)->bNotifyUpdate = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::NewProp_bNotifyUpdate = { "bNotifyUpdate", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UINavSlider_eventSetInterval_Parms), &Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::NewProp_bNotifyUpdate_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bNotifyUpdate_MetaData), NewProp_bNotifyUpdate_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::NewProp_NewInterval,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::NewProp_bNotifyUpdate,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavSlider, nullptr, "SetInterval", nullptr, nullptr, Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::UINavSlider_eventSetInterval_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::UINavSlider_eventSetInterval_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavSlider_SetInterval()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavSlider_SetInterval_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavSlider::execSetInterval)
{
	P_GET_PROPERTY(FFloatProperty,Z_Param_NewInterval);
	P_GET_UBOOL(Z_Param_bNotifyUpdate);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetInterval(Z_Param_NewInterval,Z_Param_bNotifyUpdate);
	P_NATIVE_END;
}
// End Class UUINavSlider Function SetInterval

// Begin Class UUINavSlider Function SetMaxDecimalDigits
struct Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics
{
	struct UINavSlider_eventSetMaxDecimalDigits_Parms
	{
		int32 DecimalDigits;
	};
#if WITH_METADATA
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DecimalDigits_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FIntPropertyParams NewProp_DecimalDigits;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::NewProp_DecimalDigits = { "DecimalDigits", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavSlider_eventSetMaxDecimalDigits_Parms, DecimalDigits), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DecimalDigits_MetaData), NewProp_DecimalDigits_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::NewProp_DecimalDigits,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavSlider, nullptr, "SetMaxDecimalDigits", nullptr, nullptr, Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::UINavSlider_eventSetMaxDecimalDigits_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::UINavSlider_eventSetMaxDecimalDigits_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavSlider::execSetMaxDecimalDigits)
{
	P_GET_PROPERTY(FIntProperty,Z_Param_DecimalDigits);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetMaxDecimalDigits(Z_Param_DecimalDigits);
	P_NATIVE_END;
}
// End Class UUINavSlider Function SetMaxDecimalDigits

// Begin Class UUINavSlider Function SetMaxValue
struct Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics
{
	struct UINavSlider_eventSetMaxValue_Parms
	{
		float NewValue;
		bool bNotifyUpdate;
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::NewProp_NewValue = { "NewValue", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavSlider_eventSetMaxValue_Parms, NewValue), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NewValue_MetaData), NewProp_NewValue_MetaData) };
void Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::NewProp_bNotifyUpdate_SetBit(void* Obj)
{
	((UINavSlider_eventSetMaxValue_Parms*)Obj)->bNotifyUpdate = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::NewProp_bNotifyUpdate = { "bNotifyUpdate", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UINavSlider_eventSetMaxValue_Parms), &Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::NewProp_bNotifyUpdate_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bNotifyUpdate_MetaData), NewProp_bNotifyUpdate_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::NewProp_NewValue,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::NewProp_bNotifyUpdate,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavSlider, nullptr, "SetMaxValue", nullptr, nullptr, Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::UINavSlider_eventSetMaxValue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::UINavSlider_eventSetMaxValue_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavSlider_SetMaxValue()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavSlider_SetMaxValue_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavSlider::execSetMaxValue)
{
	P_GET_PROPERTY(FFloatProperty,Z_Param_NewValue);
	P_GET_UBOOL(Z_Param_bNotifyUpdate);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetMaxValue(Z_Param_NewValue,Z_Param_bNotifyUpdate);
	P_NATIVE_END;
}
// End Class UUINavSlider Function SetMaxValue

// Begin Class UUINavSlider Function SetMinDecimalDigits
struct Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics
{
	struct UINavSlider_eventSetMinDecimalDigits_Parms
	{
		int32 DecimalDigits;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::NewProp_DecimalDigits = { "DecimalDigits", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavSlider_eventSetMinDecimalDigits_Parms, DecimalDigits), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DecimalDigits_MetaData), NewProp_DecimalDigits_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::NewProp_DecimalDigits,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavSlider, nullptr, "SetMinDecimalDigits", nullptr, nullptr, Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::UINavSlider_eventSetMinDecimalDigits_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::UINavSlider_eventSetMinDecimalDigits_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavSlider::execSetMinDecimalDigits)
{
	P_GET_PROPERTY(FIntProperty,Z_Param_DecimalDigits);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetMinDecimalDigits(Z_Param_DecimalDigits);
	P_NATIVE_END;
}
// End Class UUINavSlider Function SetMinDecimalDigits

// Begin Class UUINavSlider Function SetMinValue
struct Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics
{
	struct UINavSlider_eventSetMinValue_Parms
	{
		float NewValue;
		bool bNotifyUpdate;
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::NewProp_NewValue = { "NewValue", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavSlider_eventSetMinValue_Parms, NewValue), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NewValue_MetaData), NewProp_NewValue_MetaData) };
void Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::NewProp_bNotifyUpdate_SetBit(void* Obj)
{
	((UINavSlider_eventSetMinValue_Parms*)Obj)->bNotifyUpdate = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::NewProp_bNotifyUpdate = { "bNotifyUpdate", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UINavSlider_eventSetMinValue_Parms), &Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::NewProp_bNotifyUpdate_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bNotifyUpdate_MetaData), NewProp_bNotifyUpdate_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::NewProp_NewValue,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::NewProp_bNotifyUpdate,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavSlider, nullptr, "SetMinValue", nullptr, nullptr, Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::UINavSlider_eventSetMinValue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::UINavSlider_eventSetMinValue_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavSlider_SetMinValue()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavSlider_SetMinValue_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavSlider::execSetMinValue)
{
	P_GET_PROPERTY(FFloatProperty,Z_Param_NewValue);
	P_GET_UBOOL(Z_Param_bNotifyUpdate);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetMinValue(Z_Param_NewValue,Z_Param_bNotifyUpdate);
	P_NATIVE_END;
}
// End Class UUINavSlider Function SetMinValue
...
void UUINavSlider::StaticRegisterNativesUUINavSlider()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "SetInterval", &UUINavSlider::execSetInterval },
		{ "SetMaxDecimalDigits", &UUINavSlider::execSetMaxDecimalDigits },
		{ "SetMaxValue", &UUINavSlider::execSetMaxValue },
		{ "SetMinDecimalDigits", &UUINavSlider::execSetMinDecimalDigits },
		{ "SetMinValue", &UUINavSlider::execSetMinValue },
...
struct Z_Construct_UClass_UUINavSlider_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bUpdateWhileDraggingSlider_MetaData[] = {
		{ "Category", "UINavSlider" },
		{ "ModuleRelativePath", "Public/UINavSlider.h" },
	};
	...
	static void NewProp_bUpdateWhileDraggingSlider_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bUpdateWhileDraggingSlider;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UUINavSlider_GetCurrentValue, "GetCurrentValue" }, // 1077432298
		{ &Z_Construct_UFunction_UUINavSlider_GetSliderValue, "GetSliderValue" }, // 1039303110
		...
		{ &Z_Construct_UFunction_UUINavSlider_SetInterval, "SetInterval" }, // 2869114704
		{ &Z_Construct_UFunction_UUINavSlider_SetMaxDecimalDigits, "SetMaxDecimalDigits" }, // 86951822
		{ &Z_Construct_UFunction_UUINavSlider_SetMaxValue, "SetMaxValue" }, // 1328795673
		{ &Z_Construct_UFunction_UUINavSlider_SetMinDecimalDigits, "SetMinDecimalDigits" }, // 1469878418
		{ &Z_Construct_UFunction_UUINavSlider_SetMinValue, "SetMinValue" }, // 464145221
...
void Z_Construct_UClass_UUINavSlider_Statics::NewProp_bUpdateWhileDraggingSlider_SetBit(void* Obj)
{
	((UUINavSlider*)Obj)->bUpdateWhileDraggingSlider = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUINavSlider_Statics::NewProp_bUpdateWhileDraggingSlider = { "bUpdateWhileDraggingSlider", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUINavSlider), &Z_Construct_UClass_UUINavSlider_Statics::NewProp_bUpdateWhileDraggingSlider_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bUpdateWhileDraggingSlider_MetaData), NewProp_bUpdateWhileDraggingSlider_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUINavSlider_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUINavSlider_Statics::NewProp_bUpdateWhileDraggingSlider,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavSlider_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUINavSlider, UUINavSlider::StaticClass, TEXT("UUINavSlider"), &Z_Registration_Info_UClass_UUINavSlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUINavSlider), 3112143294U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavSlider_h_14610753(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavSlider_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavSlider_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
