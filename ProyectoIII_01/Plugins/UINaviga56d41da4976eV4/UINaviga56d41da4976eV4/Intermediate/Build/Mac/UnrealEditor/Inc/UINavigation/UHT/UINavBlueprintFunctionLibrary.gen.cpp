...
// Begin Class UUINavBlueprintFunctionLibrary Function GetValidUINavComponentInWidget
struct Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics
{
	struct UINavBlueprintFunctionLibrary_eventGetValidUINavComponentInWidget_Parms
	{
		const UPanelWidget* Widget;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::NewProp_Widget = { "Widget", nullptr, (EPropertyFlags)0x0010000000080082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavBlueprintFunctionLibrary_eventGetValidUINavComponentInWidget_Parms, Widget), Z_Construct_UClass_UPanelWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Widget_MetaData), NewProp_Widget_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UINavBlueprintFunctionLibrary_eventGetValidUINavComponentInWidget_Parms, ReturnValue), Z_Construct_UClass_UUINavComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ReturnValue_MetaData), NewProp_ReturnValue_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::NewProp_Widget,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUINavBlueprintFunctionLibrary, nullptr, "GetValidUINavComponentInWidget", nullptr, nullptr, Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::UINavBlueprintFunctionLibrary_eventGetValidUINavComponentInWidget_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::UINavBlueprintFunctionLibrary_eventGetValidUINavComponentInWidget_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UUINavBlueprintFunctionLibrary::execGetValidUINavComponentInWidget)
{
	P_GET_OBJECT(UPanelWidget,Z_Param_Widget);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UUINavComponent**)Z_Param__Result=UUINavBlueprintFunctionLibrary::GetValidUINavComponentInWidget(Z_Param_Widget);
	P_NATIVE_END;
}
// End Class UUINavBlueprintFunctionLibrary Function GetValidUINavComponentInWidget
...
void UUINavBlueprintFunctionLibrary::StaticRegisterNativesUUINavBlueprintFunctionLibrary()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetValidUINavComponentInWidget", &UUINavBlueprintFunctionLibrary::execGetValidUINavComponentInWidget },
...
struct Z_Construct_UClass_UUINavBlueprintFunctionLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_FindWidgetOfClassesInWidget, "FindWidgetOfClassesInWidget" }, // 1336472359
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetFirstWidgetInUserWidget, "GetFirstWidgetInUserWidget" }, // 1260135278
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetIndexInPanelWidget, "GetIndexInPanelWidget" }, // 2617388225
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetIndexInUniformGridWidget, "GetIndexInUniformGridWidget" }, // 1390148299
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetPanelWidgetChild, "GetPanelWidgetChild" }, // 1831834032
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetParentPanelWidget, "GetParentPanelWidget" }, // 194712456
		...
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetUniformGridChild, "GetUniformGridChild" }, // 2786786198
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_GetValidUINavComponentInWidget, "GetValidUINavComponentInWidget" }, // 3713837867
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_IsGamepadConnected, "IsGamepadConnected" }, // 89869548
		...
		{ &Z_Construct_UFunction_UUINavBlueprintFunctionLibrary_ResetInputSettings, "ResetInputSettings" }, // 4074299830
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavBlueprintFunctionLibrary_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUINavBlueprintFunctionLibrary, UUINavBlueprintFunctionLibrary::StaticClass, TEXT("UUINavBlueprintFunctionLibrary"), &Z_Registration_Info_UClass_UUINavBlueprintFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUINavBlueprintFunctionLibrary), 1936499976U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavBlueprintFunctionLibrary_h_2806259036(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavBlueprintFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavBlueprintFunctionLibrary_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
