...
static const FName NAME_UUINavWidget_GetInitialFocusComponent = FName(TEXT("GetInitialFocusComponent"));
UUINavComponent* UUINavWidget::GetInitialFocusComponent()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_GetInitialFocusComponent);
	...
	{
		return GetInitialFocusComponent_Implementation();
	}
}
...
static const FName NAME_UUINavWidget_GetScrollBoxToFocus = FName(TEXT("GetScrollBoxToFocus"));
UScrollBox* UUINavWidget::GetScrollBoxToFocus()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_GetScrollBoxToFocus);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return GetScrollBoxToFocus_Implementation();
	}
}
...
static const FName NAME_UUINavWidget_OnChangedSection = FName(TEXT("OnChangedSection"));
void UUINavWidget::OnChangedSection(const int32 FromIndex, const int32 ToIndex)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnChangedSection);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnChangedSection_Implementation(FromIndex, ToIndex);
	}
}
...
static const FName NAME_UUINavWidget_OnChildReturn = FName(TEXT("OnChildReturn"));
bool UUINavWidget::OnChildReturn()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnChildReturn);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return OnChildReturn_Implementation();
	}
}
...
static const FName NAME_UUINavWidget_OnGainedNavigation = FName(TEXT("OnGainedNavigation"));
void UUINavWidget::OnGainedNavigation(UUINavWidget* PreviousActiveWidget, bool bFromChild)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnGainedNavigation);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnGainedNavigation_Implementation(PreviousActiveWidget, bFromChild);
	}
}
...
static const FName NAME_UUINavWidget_OnHorizCompNavigateLeft = FName(TEXT("OnHorizCompNavigateLeft"));
void UUINavWidget::OnHorizCompNavigateLeft(UUINavComponent* Component)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnHorizCompNavigateLeft);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnHorizCompNavigateLeft_Implementation(Component);
	}
}
...
static const FName NAME_UUINavWidget_OnHorizCompNavigateRight = FName(TEXT("OnHorizCompNavigateRight"));
void UUINavWidget::OnHorizCompNavigateRight(UUINavComponent* Component)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnHorizCompNavigateRight);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnHorizCompNavigateRight_Implementation(Component);
	}
}
...
static const FName NAME_UUINavWidget_OnHorizCompUpdated = FName(TEXT("OnHorizCompUpdated"));
void UUINavWidget::OnHorizCompUpdated(UUINavComponent* Component)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnHorizCompUpdated);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnHorizCompUpdated_Implementation(Component);
	}
}
...
static const FName NAME_UUINavWidget_OnInputChanged = FName(TEXT("OnInputChanged"));
void UUINavWidget::OnInputChanged(const EInputType From, const EInputType To)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnInputChanged);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnInputChanged_Implementation(From, To);
	}
}
...
static const FName NAME_UUINavWidget_OnLostNavigation = FName(TEXT("OnLostNavigation"));
void UUINavWidget::OnLostNavigation(UUINavWidget* NewActiveWidget, bool bToChild)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnLostNavigation);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnLostNavigation_Implementation(NewActiveWidget, bToChild);
	}
}
...
static const FName NAME_UUINavWidget_OnNavigate = FName(TEXT("OnNavigate"));
void UUINavWidget::OnNavigate(UUINavComponent* FromComponent, UUINavComponent* ToComponent)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnNavigate);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnNavigate_Implementation(FromComponent, ToComponent);
	}
}
...
static const FName NAME_UUINavWidget_OnNext = FName(TEXT("OnNext"));
void UUINavWidget::OnNext()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnNext);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
...
static const FName NAME_UUINavWidget_OnPrevious = FName(TEXT("OnPrevious"));
void UUINavWidget::OnPrevious()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnPrevious);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
...
static const FName NAME_UUINavWidget_OnReturn = FName(TEXT("OnReturn"));
void UUINavWidget::OnReturn()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnReturn);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
...
static const FName NAME_UUINavWidget_OnSelect = FName(TEXT("OnSelect"));
void UUINavWidget::OnSelect(UUINavComponent* Component)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnSelect);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnSelect_Implementation(Component);
	}
}
...
static const FName NAME_UUINavWidget_OnSetupCompleted = FName(TEXT("OnSetupCompleted"));
void UUINavWidget::OnSetupCompleted()
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnSetupCompleted);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
	...
	{
		OnSetupCompleted_Implementation();
	}
}
...
static const FName NAME_UUINavWidget_OnStartSelect = FName(TEXT("OnStartSelect"));
void UUINavWidget::OnStartSelect(UUINavComponent* Component)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnStartSelect);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnStartSelect_Implementation(Component);
	}
}
...
static const FName NAME_UUINavWidget_OnStopSelect = FName(TEXT("OnStopSelect"));
void UUINavWidget::OnStopSelect(UUINavComponent* Component)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnStopSelect);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnStopSelect_Implementation(Component);
	}
}
...
static const FName NAME_UUINavWidget_OnThumbstickCursorInput = FName(TEXT("OnThumbstickCursorInput"));
void UUINavWidget::OnThumbstickCursorInput(FVector2D const& ThumbstickDelta)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_OnThumbstickCursorInput);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		OnThumbstickCursorInput_Implementation(ThumbstickDelta);
	}
}
...
static const FName NAME_UUINavWidget_PreSetup = FName(TEXT("PreSetup"));
void UUINavWidget::PreSetup(bool bFirstSetup)
{
	UFunction* Func = FindFunctionChecked(NAME_UUINavWidget_PreSetup);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		PreSetup_Implementation(bFirstSetup);
	}
}
...
struct Z_Construct_UClass_UUINavWidget_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UUINavWidget_ConfigureUINavPC, "ConfigureUINavPC" }, // 3672799263
		{ &Z_Construct_UFunction_UUINavWidget_GetInitialFocusComponent, "GetInitialFocusComponent" }, // 2187631767
		...
		{ &Z_Construct_UFunction_UUINavWidget_GoToBuiltWidget, "GoToBuiltWidget" }, // 2855471187
		...
		{ &Z_Construct_UFunction_UUINavWidget_GoToPromptWidget, "GoToPromptWidget" }, // 1519252645
		{ &Z_Construct_UFunction_UUINavWidget_GoToSection, "GoToSection" }, // 3042604874
		{ &Z_Construct_UFunction_UUINavWidget_GoToWidget, "GoToWidget" }, // 4136490699
		...
		{ &Z_Construct_UFunction_UUINavWidget_OnChangedSection, "OnChangedSection" }, // 1693630038
		{ &Z_Construct_UFunction_UUINavWidget_OnChildReturn, "OnChildReturn" }, // 3018176456
		{ &Z_Construct_UFunction_UUINavWidget_OnGainedNavigation, "OnGainedNavigation" }, // 520873220
		{ &Z_Construct_UFunction_UUINavWidget_OnHorizCompNavigateLeft, "OnHorizCompNavigateLeft" }, // 3724388278
		{ &Z_Construct_UFunction_UUINavWidget_OnHorizCompNavigateRight, "OnHorizCompNavigateRight" }, // 3659099854
		{ &Z_Construct_UFunction_UUINavWidget_OnHorizCompUpdated, "OnHorizCompUpdated" }, // 4198461216
		{ &Z_Construct_UFunction_UUINavWidget_OnInputChanged, "OnInputChanged" }, // 1153643451
		{ &Z_Construct_UFunction_UUINavWidget_OnLostNavigation, "OnLostNavigation" }, // 1019494462
		{ &Z_Construct_UFunction_UUINavWidget_OnNavigate, "OnNavigate" }, // 2883656955
		{ &Z_Construct_UFunction_UUINavWidget_OnNext, "OnNext" }, // 3961417107
		{ &Z_Construct_UFunction_UUINavWidget_OnPrevious, "OnPrevious" }, // 1671946775
		{ &Z_Construct_UFunction_UUINavWidget_OnReturn, "OnReturn" }, // 2845502117
		...
		{ &Z_Construct_UFunction_UUINavWidget_OnSelect, "OnSelect" }, // 488412445
		{ &Z_Construct_UFunction_UUINavWidget_OnSetupCompleted, "OnSetupCompleted" }, // 3481936328
		...
		{ &Z_Construct_UFunction_UUINavWidget_OnThumbstickCursorInput, "OnThumbstickCursorInput" }, // 2517248410
		{ &Z_Construct_UFunction_UUINavWidget_PreSetup, "PreSetup" }, // 2572218182
		{ &Z_Construct_UFunction_UUINavWidget_ReturnToParent, "ReturnToParent" }, // 1725687199
		{ &Z_Construct_UFunction_UUINavWidget_SetSelectorScale, "SetSelectorScale" }, // 3975307350
		{ &Z_Construct_UFunction_UUINavWidget_SetSelectorVisible, "SetSelectorVisible" }, // 1257470091
		{ &Z_Construct_UFunction_UUINavWidget_UpdateSelectorLocation, "UpdateSelectorLocation" }, // 933595833
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavWidget_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUINavWidget, UUINavWidget::StaticClass, TEXT("UUINavWidget"), &Z_Registration_Info_UClass_UUINavWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUINavWidget), 1299816110U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavWidget_h_3661281123(TEXT("/Script/UINavigation"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UINavigation_Source_UINavigation_Public_UINavWidget_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
